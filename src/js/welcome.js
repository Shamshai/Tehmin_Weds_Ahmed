...
export const welcome = () => {
    ...
    const generateParameterContent = () => {
        ...
        if (params) {
            weddingToElement.innerHTML = `To the Honorable Father/Mother/Brother/Sister<br><span>${params}</span>`;
            name.value = params;
        } else {
            weddingToElement.innerHTML = `To the Honorable Father/Mother/Brother/Sister<br><span>Hello, everyone</span>`;
        }
    }
